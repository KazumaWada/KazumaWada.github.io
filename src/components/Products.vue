...
<template>
  ...
  <li>🛠️ onedayoneline.com ,<a href="https://github.com/KazumaWada/onedayoneline" target="_blank"><i class="fa-brands fa-github"></i></a></li>
  <li>☠️ file directory system ,<a href="https://github.com/KazumaWada/filedirectorysystem" target="_blank"><i class="fa-brands fa-github"></i></a></li>
  <li>☠️ blog posting service ,<a href="https://github.com/KazumaWada/myapp" target="_blank"><i class="fa-brands fa-github"></i></a></li>
  ...
  <li>🚀 <a href="https://kazumawada.org" target="_blank">kazumawada.org</a> ,<a href="https://github.com/KazumaWada/kazumawada.github.io" target="_blank"><i class="fa-brands fa-github"></i></a></li>
</div>
</v-container>
