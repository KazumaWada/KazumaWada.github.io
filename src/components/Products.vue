...
<template>
  ...
  <li>🛠️ onedayoneline.com <a href="https://github.com/KazumaWada/onedayoneline" target="_blank"> <i class="fa-brands fa-github"></i></a> <button @click="handleClick"> README</button></li>
